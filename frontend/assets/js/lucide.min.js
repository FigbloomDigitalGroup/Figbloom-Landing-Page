...
(function(a, n) {
    typeof exports == "object" && typeof module < "u" ? n(exports) : typeof define == "function" && define.amd ? define(["exports"], n) : (a = typeof globalThis < "u" ? globalThis : a || self,
    n(a.lucide = {}))
}
)(this, (function(a) {
    "use strict";
    const n = {
      ...
      , ru = t => Array.from(t.attributes).reduce( (h, d) => (h[d.name] = d.value,
    h), {})
      , ou = t => typeof t == "string" ? t : !t || !t.class ? "" : t.class && typeof t.class == "string" ? t.class.split(" ") : t.class && Array.isArray(t.class) ? t.class : ""
      , vu = t => t.flatMap(ou).map(h => h.trim()).filter(Boolean).filter( (h, d, c) => c.indexOf(h) === d).join(" ")
      , $u = t => t.replace(/(\w)(\w*)(_|-|\s*)/g, (h, d, c) => d.toUpperCase() + c.toLowerCase())
    ...
    const iu = ({icons: t=pu, nameAttr: h="data-lucide", attrs: d={}, root: c=document, inTemplates: M}={}) => {
...
lucide.createIcons({icons});\``);
        ...
        M && Array.from(c.querySelectorAll("template")).forEach(p => iu({
            icons: t,
            nameAttr: h,
            attrs: d,
            root: p.content,
